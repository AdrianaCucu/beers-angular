...
var BeerDetailsComponent = /** @class */ (function () {
    function BeerDetailsComponent(favouritesService, beersService, cartService, router) {
        var _this = this;
        ...
        router.events.subscribe(function (val) {
            val instanceof _angular_router__WEBPACK_IMPORTED_MODULE_2__["NavigationEnd"]
                ? ((_this.id = val.url.replace(/\D/g, '')), _this.ngOnInit())
                : null;
            // console.log(this.id);
     ...
     */
    BeerDetailsComponent.prototype.validateId = function (id) {
        return /^\d+$/.test(id) && parseInt(id, 10) > 0 && parseInt(id, 10) < 326;
    };
    BeerDetailsComponent.prototype.updatePage = function () {
        var _this = this;
        if (this.validateId(this.id)) {
            this.beersService.getSelectedBeer(this.id).subscribe(function (item) { return ((_this.items = item),
                (_this.abv = _this.items[0].abv),
                _this.beersService.getSimilarBeers(_this.abv).subscribe(function (similar) { return (_this.similarItems = similar); }
    ...
    BeerDetailsComponent.prototype.isInFavourites = function (beer) {
        return this.favouritesService.isInFavourites(beer);
    };
    BeerDetailsComponent.prototype.updateFavourites = function (beer) {
        this.favouritesService.updateFavourites(beer);
    };
    BeerDetailsComponent.prototype.isInCart = function (beer) {
        return this.cartService.isInCart(beer);
    };
    BeerDetailsComponent.prototype.updateCart = function (beer) {
...
var BeerListComponent = /** @class */ (function () {
    function BeerListComponent(beersService, favouritesService, cartService) {
        this.beersService = beersService;
        this.favouritesService = favouritesService;
        this.cartService = cartService;
    }
    ...
    BeerListComponent.prototype.updateFilter = function () {
        this.ngOnInit();
    };
    BeerListComponent.prototype.updatePage = function () {
        var _this = this;
        // Random beer.
        if (this.filters.includes('random')) {
            this.beersService
                .getBeers(this.page, 'random')
                .subscribe(function (items) { return (_this.beers = items); });
        }
        ...
        // If 'random' is not selected.
            ...
            this.beersService.getBeers(this.page).subscribe(function (items) {
                var _a;
                return ((_this.currentBeers = items), (_a = _this.allBeers).push.apply(_a, tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](_this.currentBeers)),
                    (_this.beers = _this.beersService.filterBeers(_this.allBeers)),
                    _this.beers.sort(function (a, b) { return (a.id > b.id ? 1 : -1); }), // Sorts the beers by id.
                    // This is used when a filter only has less than 10 beers on the first page/pages.
                    _this.beers.length < 10
                        ? _this.getNextBeers()
                        : null
                // For testing:
    ...
    BeerListComponent.prototype.isInFavourites = function (beer) {
        return this.favouritesService.isInFavourites(beer);
    };
    BeerListComponent.prototype.updateFavourites = function (beer) {
        this.favouritesService.updateFavourites(beer);
    };
    BeerListComponent.prototype.isInCart = function (beer) {
        return this.cartService.isInCart(beer);
    };
    BeerListComponent.prototype.updateCart = function (beer) {
        this.cartService.updateCart(beer);
    };
    BeerListComponent.prototype.getNextBeers = function () {
        this.page++;
        this.updatePage();
    };
    BeerListComponent.prototype.scrollHandler = function (e) {
        // console.log(e);
        if (e === 'bottom') {
            this.getNextBeers();
        }
...
var CartComponent = /** @class */ (function () {
    function CartComponent(cartService, route) {
        var _this = this;
        this.cartService = cartService;
        this.route = route;
        this.items = this.cartService.getItems();
        route.params.subscribe(function (params) { return (_this.link = params['cart-link']); });
        // console.log(this.link);
    }
    CartComponent.prototype.ngOnInit = function () {
        this.deviceWidth = window.innerWidth;
    };
    CartComponent.prototype.removeBeer = function (beer) {
        this.cartService.removeFromCart(beer);
    };
    CartComponent.prototype.addToCart = function (beer) {
...
var ClientDetails = /** @class */ (function () {
    function ClientDetails(firstName, lastName, address, country, cardType, cardNumber, cvc, expirationMonth, expirationYear, apartment, items, orderDate) {
...
var FavouritesComponent = /** @class */ (function () {
    function FavouritesComponent(favouritesService, cartService) {
        this.favouritesService = favouritesService;
        this.cartService = cartService;
    }
    ...
    FavouritesComponent.prototype.removeBeer = function (beer) {
        this.favouritesService.removeFromFavourites(beer);
    };
    FavouritesComponent.prototype.isInCart = function (beer) {
        return this.cartService.isInCart(beer);
    };
    FavouritesComponent.prototype.updateCart = function (beer) {
        this.cartService.updateCart(beer);
    };
    FavouritesComponent.prototype.clearFavourites = function () {
...
var NavBarComponent = /** @class */ (function () {
    function NavBarComponent(beersService) {
        this.beersService = beersService;
    ...
    NavBarComponent.prototype.filterSelected = function (filter) {
        return this.beersService.containsFilter(filter);
    };
    NavBarComponent.prototype.handleInput = function (event) {
        this.beersService.resetFilters();
        this.beersService.setName(event.target.value);
        this.selectFilter('name');
    };
    NavBarComponent.prototype.selectFilter = function (filter) {
        if (filter === 'reset') {
            this.beersService.resetFilters();
        }
        else {
...
var OrderFormComponent = /** @class */ (function () {
    function OrderFormComponent(cartService, orderService) {
        this.cartService = cartService;
    ...
    OrderFormComponent.prototype.clearCart = function () {
        this.cartService.clearCart();
        window.location.reload();
    };
    ...
    OrderFormComponent.prototype.submitForm = function () {
...
var ScrollableDirective = /** @class */ (function () {
    ...
    ScrollableDirective.prototype.onScroll = function (event) {
        try {
            ...
            var offset = this.element.nativeElement.offsetHeight;
...
var BeersService = /** @class */ (function () {
     ...
     */
    BeersService.prototype.getSelectedBeer = function (id) {
        return this.http.get(this.API_PATH + "/beers/" + id);
    };
    // Beer name provided by the user.
    BeersService.prototype.setName = function (name) {
        this.name = name.replace(/\s+/g, '_');
    };
    BeersService.prototype.getFilters = function () {
        // console.log(this.filters);
        return this.filters;
    };
    BeersService.prototype.containsFilter = function (filter) {
        // console.log(this.filters.includes(filter));
        return this.filters.includes(filter);
    };
    BeersService.prototype.addFilter = function (filter) {
        var exists = false;
        if (this.filters.length) {
            for (var i = 0; i < this.filters.length && !exists; i++) {
    ...
    BeersService.prototype.removeFilter = function (filter) {
    ...
    BeersService.prototype.resetFilters = function () {
        this.filters = [];
        localStorage.setItem('filters', JSON.stringify(this.filters));
        // console.log('storage-filters');
        // console.log(localStorage.getItem('filters'));
     ...
     */
    BeersService.prototype.getBeers = function (page, filter) {
    ...
    BeersService.prototype.filterBeers = function (beers) {
    ...
    BeersService.prototype.filterABV = function (beers) {
        var e_1, _a;
        var filteredBeers = [];
        try {
            for (var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](this.filters), _c = _b.next(); !_c.done; _c = _b.next()) {
                var filter = _c.value;
                switch (filter) {
                    case 'weak': {
                        filteredBeers.push.apply(filteredBeers, tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](beers.filter(function (beer) { return beer.abv < 5; })));
                        break;
                    }
                    case 'medium': {
                        filteredBeers.push.apply(filteredBeers, tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](beers.filter(function (beer) { return beer.abv >= 5 && beer.abv <= 10; })));
                        break;
                    }
                    case 'strong': {
                        filteredBeers.push.apply(filteredBeers, tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](beers.filter(function (beer) { return beer.abv > 10; })));
                        break;
                    }
                }
            }
    ...
    BeersService.prototype.filterIBU = function (beers) {
        var e_2, _a;
        var filteredBeers = [];
        try {
            for (var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](this.filters), _c = _b.next(); !_c.done; _c = _b.next()) {
                ...
                switch (filter) {
                    case 'low': {
                        filteredBeers.push.apply(filteredBeers, tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](beers.filter(function (beer) { return beer.ibu < 15; })));
                        break;
                    }
                    case 'normal': {
                        filteredBeers.push.apply(filteredBeers, tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](beers.filter(function (beer) { return beer.ibu >= 15 && beer.ibu <= 80; })));
                        break;
                    }
                    case 'high': {
                        filteredBeers.push.apply(filteredBeers, tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](beers.filter(function (beer) { return beer.ibu > 80; })));
                        break;
                    }
                }
            }
    ...
    BeersService.prototype.getSimilarBeers = function (abv) {
...
var CartService = /** @class */ (function () {
    ...
    CartService.prototype.isInCart = function (beer) {
        var exists = false;
        if (this.items.length) {
            for (var i = 0; i < this.items.length && !exists; i++) {
    ...
    CartService.prototype.updateCart = function (beer) {
        this.isInCart(beer) ? this.removeFromCart(beer) : this.addToCart(beer);
    };
    CartService.prototype.addToCart = function (beer) {
        var exists = this.isInCart(beer);
        if (!exists) {
            beer.quantity = 1;
     ...
     */
    CartService.prototype.removeFromCart = function (beer) {
...
var FavouritesService = /** @class */ (function () {
    ...
    FavouritesService.prototype.isInFavourites = function (beer) {
        var exists = false;
        if (this.items.length) {
            for (var i = 0; i < this.items.length && !exists; i++) {
                if (beer.id === this.items[i].id) {
     ...
     */
    FavouritesService.prototype.updateFavourites = function (beer) {
        this.isInFavourites(beer)
            ? this.removeFromFavourites(beer)
            : this.addToFavourites(beer);
    };
    FavouritesService.prototype.addToFavourites = function (beer) {
        var exists = this.isInFavourites(beer);
        if (!exists) {
            this.items.push(beer);
        }
        // console.log(this.items);
     ...
     */
    FavouritesService.prototype.removeFromFavourites = function (beer) {
        for (var i = 0; i < this.items.length; i++) {
            if (beer.id === this.items[i].id) {
                this.items.splice(i, 1);
            }
    ...
    FavouritesService.prototype.getItems = function () {
        // console.log(localStorage.getItem('favourites'));
        return this.items;
    };
    /**
...
var OrderService = /** @class */ (function () {
    ...
    OrderService.prototype.getCurrentDate = function () {
        var today = new Date();
    ...
    OrderService.prototype.updateOrders = function (order) {
